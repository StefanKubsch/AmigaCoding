...
vasmm68k_mot -Fhunk -showopt -o "SineScroller_asm.o" "SineScroller_asm.s"

vc -O4 -speed -final -sc -cpu=68000 SineScroller.c "SineScroller_asm.o" ".\lwmf\include\lwmf_hardware_vasm.o" ".\lwmf\include\lwmf_math_vasm.o" ".\lwmf\include\lwmf_ptplayer.o" -o SineScroller -lamiga