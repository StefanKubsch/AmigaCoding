...
void lwmf_BlitTile(__reg("a0") long* SrcAddr, __reg("a1") long* DstAddr, __reg("d0") WORD SrcX, __reg("d1") WORD SrcY, __reg("d2") WORD PosX, __reg("d3") WORD PosY, __reg("d4") WORD Width, __reg("d5") WORD Height);
