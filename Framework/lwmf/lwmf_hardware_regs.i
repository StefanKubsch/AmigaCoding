...
NUMBEROFBITPLANES   equ     5

BYTESPERROW			equ     SCREENWIDTH/8
SCREENWIDTHTOTAL	equ		BYTESPERROW*NUMBEROFBITPLANES
SCREENCLRSIZEBLT    equ     (SCREENHEIGHT/2)*NUMBEROFBITPLANES*64+BYTESPERROW/2	; half screen size for blitter part of screen clear (top -> mid)
...
VPOSR               equ     $00DFF004				; read vertical most-significant bits (and frame flop)
