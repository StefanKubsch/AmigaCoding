# Generates constants shared by the C and vasm parts of the Rotozoomer OCS build.
...
def copper_layout(slot_words):
    ...
    index += 4                         # BPL5DAT/BPL6DAT control-word writes
...
# No mode-specific generated constants are needed here.
...
DEFS.extend([
    ...
    ("HAM_CONTROL_WORD_P5", 0x3333, "HAM control plane 5 pattern", "hex4"),
    ("HAM_CONTROL_WORD_P6", 0x6666, "HAM control plane 6 pattern", "hex4"),
...
def write_c(path):
    with open(path, "w", newline="\n") as f:
        ...
        f.write("// Shared constants for the Rotozoomer OCS build.\n\n")
