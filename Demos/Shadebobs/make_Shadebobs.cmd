...
vasmm68k_mot -Fhunk -showopt -o "Shadebobs_vasm.o" "Shadebobs_vasm.s"

vc -O4 -speed -final -sc -cpu=68000 Shadebobs.c ".\lwmf\include\lwmf_hardware_vasm.o" ".\lwmf\include\lwmf_math_vasm.o" "Shadebobs_vasm.o" -o Shadebobs -lamiga