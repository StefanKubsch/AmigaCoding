...
ASM_SRC=Shadebobs_vasm.s
ASM_OBJ=Shadebobs_vasm.o
C_SRC=Shadebobs.c
...
$(PROG): $(C_SRC) $(LWMF_HW_OBJ) $(ASM_OBJ) $(LWMF_HW_DEFS)
	vc $(VC_TARGET) $(VBCC_NDK_INCLUDE) -O4 -speed -final -sd -sc -cpu=68000 $(C_SRC) "$(LWMF_HW_OBJ)" "$(ASM_OBJ)" -o $(PROG) -lamiga
