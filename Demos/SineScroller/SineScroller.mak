...
ASSETS_SRC=SineScroller_Assets.s
ASSETS_OBJ=SineScroller_Assets.o

ASM_SRC=SineScroller_vasm.s
ASM_OBJ=SineScroller_vasm.o
C_SRC=SineScroller.c
...
$(PROG): $(C_SRC) $(ASM_OBJ) $(ASSETS_OBJ) $(LWMF_HW_OBJ) $(LWMF_HW_DEFS) $(SHARED_H)
	vc $(VC_TARGET) $(VBCC_NDK_INCLUDE) -O4 -speed -final -sc -cpu=68000 $(C_SRC) "$(ASM_OBJ)" "$(ASSETS_OBJ)" "$(LWMF_HW_OBJ)" -o $(PROG) -lamiga
