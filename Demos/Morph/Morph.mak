...
ASM_SRC=Morph_vasm.s
ASM_OBJ=Morph_vasm.o
C_SRC=Morph.c
...
$(PROG): $(C_SRC) $(ASM_OBJ) $(LWMF_HW_OBJ) $(LWMF_HW_DEFS)
	vc $(VC_TARGET) $(VBCC_NDK_INCLUDE) -O4 -speed -final -sc -cpu=68000 $(C_SRC) "$(ASM_OBJ)" "$(LWMF_HW_OBJ)" -o $(PROG) -lamiga
