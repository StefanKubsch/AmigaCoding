...
vasmm68k_mot -Fhunk -showopt -o "Morph_vasm.o" "Morph_vasm.s"

vc -O4 -speed -final -sc -cpu=68000 Morph.c ".\lwmf\include\lwmf_hardware_vasm.o" ".\lwmf\include\lwmf_math_vasm.o" "Morph_vasm.o" -o Morph -lamiga
